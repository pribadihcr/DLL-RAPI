...
# def landmark_transform(landmark):
#   with tf.variable_scope('landmark_transform') as scope:
#     cx0,cx1,cx2,cx3,cx4, cy0,cy1,cy2,cy3,cy4 = landmark
#     out_landmark = [[]]*10
#     out_landmark[0] = cx0 - w/2
#     out_landmark[1] = cx1 - w / 2
#     out_landmark[2] = cx2 - w / 2
#     out_landmark[3] = cx3 - w / 2
#     out_landmark[4] = cx4 - w / 2
#
#     out_landmark[5] = cy0 -  h/2
#     out_landmark[6] = cy1 - h / 2
#     out_landmark[7] = cy2 - h / 2
#     out_landmark[8] = cy3 - h / 2
#     out_landmark[9] = cy4 - h / 2
#
#
#   return out_landmark
