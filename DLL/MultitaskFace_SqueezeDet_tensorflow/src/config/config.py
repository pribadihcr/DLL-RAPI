...
def base_model_config(dataset='PASCAL_VOC'):
  ...
  if cfg.DATASET == 'PASCAL_VOC':
    ...
    cfg.CLASS_NAMES = ('01cry', '02cute', '03normal', '04sleep', '06faceadult')#('car', 'pedestrian', 'cyclist')
    cfg.POSE_NAMES = ('01frontal', '02nonfrontal')
    cfg.AGE_NAMES = ('01baby', '02adult')
  ...
  # image width
  cfg.IMAGE_WIDTH = 480#224

  # image height
  cfg.IMAGE_HEIGHT = 240#224
  ...
  cfg.LOSS_COEF_LANDMARK = 10.0
  cfg.LOSS_COEF_POSE = 1.0
  cfg.LOSS_COEF_AGE = 1.0
